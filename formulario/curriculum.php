...
<body>
    <div class="page">
		<div class="header">
            <img src="foto.jpg" alt="Alejandro" style="max-width: 120px;"class = "imagen-circular">
        ...
        <div class="main">
            <div class="left-column">
                ...
                <div class="contact">
					...
					<p><strong>Mi perfil de GitHub </strong><a href="https://github.com/Famirlol">Click aqui</a>
